...
from common.utils import get_data_format, load_all_data

os.environ["WANDB_PROJECT"] = "flan_t5_classification"
...
def main(args):
    ...
    df_train = load_all_data(config["train_file"], config["label"])

    # loading dataset
    dataset, max_source_length, max_target_length = get_data_format(args, tokenizer, df_train)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrained_ckpt", default="google/flan-t5-base")
    ...
    parser.add_argument("--train_sample_fraction", default=0.8, type=float)
